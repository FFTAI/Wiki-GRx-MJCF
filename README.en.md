...
<img src="./pictures/GR2.png" width="300" height="360" />
...
5. Refine the MJCF file:
    ...
    - The refined MJCF file should be placed in the `./models/GR2/scene/` directory.
...
Thank you for your interest in the Fourier Intelligence GR2 robot project!  
